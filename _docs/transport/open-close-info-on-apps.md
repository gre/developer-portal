...
Call example at the time of writing this page: [In the Ledger Live source code](https://github.com/LedgerHQ/ledger-live/tree/main/ledger-live-common/src/hw/getAppAndVersion.ts#L10)
...
B0A7000000
```
Call example at the time of writing this page: [In the Ledger Live source code](https://github.com/LedgerHQ/ledger-live/tree/main/ledger-live-common/src/hw/quitApp.ts#L3)
...
Call example at the time of writing this page: [In the Ledger Live source code](https://github.com/LedgerHQ/ledger-live/tree/main/ledger-live-common/src/hw/openApp.ts#L3)
