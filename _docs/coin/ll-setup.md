...
other envs can be seen in [ledger-live/libs/live-common/src/env.js](https://github.com/LedgerHQ/ledger-live/tree/main/libs/ledger-live-common/src/env.js)
...
[A more exhaustive list of documented environment variables can be found here](https://github.com/LedgerHQ/ledger-live/tree/main/libs/ledger-live-common/src/env.ts).
...
- Connection via HTTP bridge
  ...
  - Install the [ledger-live cli](https://github.com/LedgerHQ/ledger-live/tree/main/libs/ledger-live-common/docs/cli.md).
