...
- Join our Discord server using [this link](https://developers.ledger.com/discord-pro) and post a message in the [#blockchain](https://discord.com/channels/885256081289379850/907623688759803935) channel mentioning **@Dev Support** saying that you wish to be part of Ledger Live Participant integration
