...
When building ledger-live-common, a [script](https://github.com/LedgerHQ/LedgerHQ/ledger-live/tree/main/ledger-live-common/scripts/buildReactIcons.js) automatically converts them to React and React Native components.
